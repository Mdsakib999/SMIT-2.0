...
const Banner = () => {
    ...
    return (
        <>
            <div className=" h-[calc(100vh-96px)] scale-x-[-1] " style={{ background: 'url("/public/Half Round BG.png") no-repeat center center / cover' }} >
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} >
                <iframe className="h-full w-full md:h-96 md:w-[500px]" src="https://www.youtube.com/embed/NSAOrGb9orM?si=nbE501uYgdNZtQ83" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </Modal>
        </>
    );
};
