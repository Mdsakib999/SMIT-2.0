...
const Footer = () => {
    return (
        <footer className=" relative z-10 bg-black text-white pb-10 pt-20 lg:pt-[80px]">
          ...
          <div className="mx-4 flex justify-between flex-wrap">
            <div className=" w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                Our core principle is providing exceptional service to fuel our clients' business growth.
                </p>
            ...
            <div className=" w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibold text-dark dark:text-white lg:text-center">
                  Follow Us On
                </h4>
                <div className="mb-6 flex lg:flex-col items-center lg:gap-3">
                  <a
        ...
        <p className='text-center lg:mt-5 font-bold'>© SM IT Solution 2024</p>
      </footer>
    );
};
