                ...
                <ul className='hidden md:flex items-center'>
                    ...
                    <Link to={`/contact`} className="p-4 flex flex-col items-center justify-center">
                        <div className="cursor-pointer md:text-[18px]">
                            <button className="relative inline-flex items-center justify-center px-6 py-2 overflow-hidden font-medium text-orange-600 transition duration-300 ease-out border-2 border-orange-500 rounded-full shadow-md group">
                                ...
                                <span className="absolute flex items-center justify-center w-full h-full text-orange-500 transition-all duration-300 transform group-hover:translate-x-full ease">Contact</span>
